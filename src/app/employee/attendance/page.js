...
import AttendanceWebcam from "./AttendanceWebcam";
...
export default function AttendancePage({ user: propUser }) {
    ...
    const [activeSubTab, setActiveSubTab] = useState("overview"); // "overview" (Console/Stats) or "detailed" (Log)
    ...
    const calendarDays = useMemo(() => {
        ...
        // Helper to format date as YYYY-MM-DD in local time (preventing timezone shifting offsets)
        ...
        <div className="space-y-12">
            <header className="flex justify-between items-center">
                ...
                <div className="flex bg-slate-100 p-1.5 rounded-2xl border border-slate-200">
                    <button
                        ...
                        className={`px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer ${activeSubTab === "overview" ? "bg-white text-slate-900 shadow-xl" : "text-slate-400 hover:text-slate-600"}`}
                    >
                        Registry Console
                    </button>
                    <button
                        ...
                        className={`px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer ${activeSubTab === "detailed" ? "bg-white text-slate-900 shadow-xl" : "text-slate-400 hover:text-slate-600"}`}
                    >
                        Historical Log
                    </button>
                </div>
            ...
            <AnimatePresence mode="wait">
                {activeSubTab === "overview" ? (
                    ...
                    >
                        {/* 🛠️ LEFT SIDE: COMMAND & STATS */}
                        <div className="lg:col-span-5 space-y-10">
                            {/* Mission Console (Check-in/out) */}
