    ...
    <div className="flex flex-col gap-8 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-extrabold text-indigo-600 bg-indigo-50 border border-indigo-100/50 px-2 py-0.5 rounded uppercase tracking-wider">
              Self Service Portal
            </span>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: "WFH / WFO", value: `${wfhCount} / ${wfoCount}`, color: "text-indigo-700 font-mono", borderStyle: "border-l-indigo-500" },
        ].map((stat, i) => (
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col gap-6">
        <div className="flex flex-col gap-1">
          <span className="text-[10px] font-extrabold text-violet-600 bg-violet-50 border border-violet-100/50 px-2 py-0.5 rounded w-fit uppercase tracking-wider">
            New Request
          </span>
            ...
            <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs font-medium border border-slate-200 rounded-xl bg-slate-50 focus:outline-none focus:border-indigo-400 focus:bg-white transition-all"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-extrabold text-slate-500 uppercase tracking-wider flex items-center gap-1">
              ...
              {activeForm === "WFO" && (
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs font-medium border border-slate-200 rounded-xl bg-slate-50 focus:outline-none focus:border-emerald-400 focus:bg-white transition-all"
                  />
                </div>
              )}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 text-xs font-medium border border-slate-200 rounded-xl bg-slate-50 focus:outline-none focus:border-indigo-400 focus:bg-white transition-all resize-none"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-1 border-t border-slate-100">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2 rounded-xl text-xs font-bold text-white shadow-sm transition-all cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed ${
                    activeForm === "WFH" ? "bg-indigo-600 hover:bg-indigo-700" : "bg-emerald-600 hover:bg-emerald-700"
                  }`}
                >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {detailRequest.managerComments && (
                    <div className="p-3 rounded-xl bg-indigo-50 border border-indigo-100">
                      <span className="text-[9px] font-black text-indigo-600 uppercase tracking-wider block mb-0.5">Manager</span>
