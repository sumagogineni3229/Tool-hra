  ...
  return (
    <div className="space-y-8 font-sans antialiased text-slate-800 animate-fade-in pb-12 text-left select-none">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-2xl border border-slate-200/80 shadow-sm relative overflow-hidden">
        <div className="absolute right-0 top-0 h-full w-1/3 opacity-[0.03] bg-gradient-to-l from-rose-650 to-transparent pointer-events-none" />
        <div className="space-y-2 text-left">
          <div className="inline-flex items-center gap-2 bg-rose-50 text-rose-700 px-3 py-1 rounded-full text-[10px] font-bold border border-rose-100">
            <Briefcase className="w-3 h-3 text-rose-650" />
        ...
        <div className="flex items-center flex-wrap gap-4 w-full lg:w-auto">
          ...
          <div className="relative flex-1 lg:w-72">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 border border-slate-200 rounded-xl text-xs bg-slate-50/50 focus:outline-none focus:border-rose-500 focus:bg-white transition-all font-semibold text-slate-800"
            />
          </div>
          ...
          <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
            ...
            <select
              ...
              className="bg-white border border-slate-200 rounded-xl px-2.5 py-1.5 text-xs font-bold text-slate-700 cursor-pointer focus:outline-none focus:border-rose-500"
            >
            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                  <h4 className="font-bold text-slate-900 text-sm tracking-tight truncate flex-1 text-left group-hover:text-rose-600 transition-colors" title={project.name}>
                    {project.name}
                  </h4>
                ...
                <div className="space-y-2 pt-1 text-left bg-rose-50/20 border border-rose-100/30 p-3 rounded-xl">
                  <div className="flex justify-between items-center text-[9px] font-bold text-rose-800 uppercase tracking-wide">
                    <span>My Contribution</span>
                    <span className="text-rose-950 font-black">{getOwnContribution(project)}%</span>
                  </div>
                ...
                <div className="pt-3 border-t border-slate-100 mt-1">
                  <button
                    ...
                    className="w-full bg-rose-50 hover:bg-rose-600 border border-rose-100 hover:border-rose-600 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider text-rose-700 hover:text-white cursor-pointer active:scale-95 transition-all text-center flex items-center justify-center gap-1.5 shadow-sm"
                  >
            ...
            >
              ...
              <div className="flex justify-between items-start pb-5 border-b border-slate-100 shrink-0">
                <div className="flex items-center gap-3.5 min-w-0">
                  <div className="w-11 h-11 rounded-xl bg-rose-50 border border-rose-100 flex items-center justify-center text-rose-650 shrink-0 shadow-inner">
              ...
              <div className="flex-1 overflow-y-auto max-h-[60vh] pr-2 grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-7 space-y-6 text-left">
                  ...
                  <div className="space-y-3.5 text-left bg-rose-50/20 border border-rose-100 p-5 rounded-2xl">
                    <div className="flex justify-between items-center text-[10px] font-black text-rose-800 uppercase tracking-wider">
                      <span>My Contribution Progress</span>
                      <span className="text-rose-955 text-sm font-black">{getOwnContribution(selectedProject)}%</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <input
                        ...
                        className="flex-1 accent-rose-500 h-1.5 bg-rose-100/50 rounded-lg cursor-pointer"
                      />
                      <span className="text-[10px] text-rose-700 font-bold">Slide to update contribution</span>
                    </div>
                  </div>
                        ...
                        {selectedProject.assignedMembers.map((member) => (
                          <div key={member.email} className="p-3.5 border border-slate-200 rounded-xl bg-white shadow-sm flex flex-col justify-between gap-3">
                            <div className="flex items-center gap-2">
                              <div className="w-7 h-7 rounded-lg bg-rose-50 text-rose-700 border border-rose-100 flex items-center justify-center text-[9px] font-black">
                      ...
                      <div className="border-l-2 border-slate-100 pl-4 space-y-4 max-h-56 overflow-y-auto">
                        {selectedProject.activityTimeline.map((log, idx) => (
                          <div key={idx} className="relative text-xs leading-normal">
                            <span className="absolute -left-[21px] top-1 w-2 h-2 rounded-full bg-rose-500" />
                ...
                <div className="lg:col-span-5 space-y-6 text-left border-t lg:border-t-0 lg:border-l border-slate-100 pt-6 lg:pt-0 lg:pl-6">
                  ...
                  <div className="bg-rose-50/20 border border-rose-100 p-5 rounded-2xl space-y-3">
                    <h5 className="text-[10px] font-black text-rose-800 uppercase tracking-widest leading-none flex items-center gap-1.5">
                    ...
                    <label className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-dashed border-rose-300 bg-white text-xs font-bold text-rose-700 hover:bg-rose-50 transition-all cursor-pointer shadow-sm select-none">
                      {isUploadingDeliverable ? (
                        <>
                          <div className="w-3.5 h-3.5 rounded-full border-2 border-rose-500/30 border-t-rose-600 animate-spin" />
                    ...
                    <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4 space-y-4 max-h-64 overflow-y-auto">
                      ...
                      <form onSubmit={handleAddComment} className="flex gap-2 pt-2 border-t border-slate-200">
                        <input
                          ...
                          className="flex-1 bg-white border border-slate-250 rounded-xl px-3 py-2 text-xs font-semibold focus:outline-none focus:border-rose-500"
                        />
                        <button
                          type="submit"
                          disabled={isSubmittingComment || !newComment.trim()}
                          className="w-9 h-9 rounded-xl bg-rose-500 hover:bg-rose-650 text-white flex items-center justify-center cursor-pointer active:scale-95 transition-all shrink-0 disabled:opacity-50"
                        >
