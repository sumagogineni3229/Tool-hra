...
export default function AnnouncementsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...formData,
        email: currentUser?.email // passed down for programatic fallback lookups
      };
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-2xl border border-slate-200/80 shadow-sm relative overflow-hidden">
        ...
        <div className="space-y-2 text-left">
          ...
          <p className="text-xs font-medium text-slate-400 max-w-xl">
            Publish official HRA Groups corporate bulletins, upload policies, broadcast urgent news, and target visibility to specific user roles.
          </p>
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                      ...
                      {/* Action buttons (only HR or Admin can delete, which matches our verification checks) */}
