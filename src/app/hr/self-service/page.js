...
export default function HRSelfServiceApproval() {
  ...
  return (
    <div className="space-y-12">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">Self Service Portal Reviews</h2>
          <p className="text-slate-500 font-light text-lg italic tracking-wide">Approve and monitor staff WFH or WFO requests.</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-2">
        {[
          { label: "Total Applications", count: totalCount, icon: FileText, bg: "from-blue-50/50 to-indigo-50/10 border-blue-100/50 text-blue-600" },
          { label: "Pending Reviews", count: pendingCount, icon: ShieldAlert, bg: "from-amber-50/50 to-orange-50/10 border-amber-100/50 text-amber-600" },
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-6 pb-2 border-b border-slate-100/50">
          ...
          <div className="flex bg-slate-50 border border-slate-100/80 p-1.5 rounded-2xl w-fit">
            {[
              ...
              { id: "archive", label: "Archive Log", badge: processed.length, color: "bg-slate-450" },
            ].map((tab) => (
              <button
                key={tab.id}
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              placeholder="Search staff, reasons, WFH/WFO..."
        ...
        <div className="min-h-[250px] relative">
          {loading ? (
            <div className="py-24 text-center text-slate-450 font-black uppercase tracking-widest animate-pulse flex flex-col items-center justify-center gap-4">
              ...
              <span>Syncing Request Registry...</span>
            </div>
          ) : activeTab === "pending" ? (
            <AnimatePresence mode="popLayout">
              {pending.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-slate-400 font-light italic text-sm max-w-xs mx-auto">No pending self-service requests requiring HR verification.</p>
                </motion.div>
              ) : (
                      ...
                      >
                        <div className="space-y-3 flex-1 min-w-0">
                          ...
                          <div className="text-xs text-slate-600 font-semibold leading-none flex items-center gap-2">
                            <span className="text-indigo-600 font-bold">{cfg.label}</span>
                            <span>—</span>
                          ...
                          {/* Comments rationale */}
                          {req.hrComments && (
                            <div className="p-3 bg-indigo-50/30 border border-indigo-100/50 rounded-xl max-w-xl">
                              <p className="text-[10px] font-black text-indigo-500 uppercase tracking-widest mb-1.5">
                                HR Review Comments:
                              </p>
                              <p className="text-xs font-medium text-slate-700 leading-relaxed italic">
                                &ldquo;{req.hrComments}&rdquo;
                              </p>
                            </div>
                          )}
            ...
            <div className="border-b border-slate-100 px-8 py-5 bg-slate-50 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">HR Clearance Review</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleAction} className="p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-150 rounded-2xl px-4 py-3 focus:bg-white outline-none text-xs font-medium text-slate-800 leading-relaxed transition-all resize-none"
