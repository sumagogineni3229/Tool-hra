...
export default function InternTasksPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      console.error("Failed to load intern tasks dataset:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-12 w-full max-w-none text-left">
      ...
      {/* Balance Grid style for Tasks Metrics */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-2">
        {[
          ...
          { label: "Tasks In Progress", count: stats.inProgress, icon: Clock, bg: "from-indigo-50/50 to-purple-50/10 border-indigo-100/50 text-indigo-655" },
          { label: "Pending Tasks", count: stats.pending, icon: AlertCircle, bg: "from-amber-50/50 to-orange-50/10 border-amber-100/50 text-amber-655" },
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-6 pb-4 border-b border-slate-100">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 focus:bg-white outline-none font-semibold text-slate-800 placeholder-slate-400 text-xs transition-all shadow-inner focus:border-amber-500"
            />
          </div>
            ...
            <div className="space-y-4">
              {filteredTasks.map((task) => (
                <motion.div
                  ...
                  className="bg-white border border-slate-200/80 p-6 rounded-2xl hover:border-amber-350 transition-all text-left flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 shadow-sm"
                >
                  ...
                  <div className="space-y-2.5 flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-[10px] font-bold text-slate-455 select-none pt-1">
                  ...
                  <div className="flex items-center gap-3.5 shrink-0 w-full lg:w-auto justify-between lg:justify-end border-t border-slate-100 lg:border-t-0 pt-4 lg:pt-0">
                    ...
                    <button
                      ...
                      className="px-6 py-3 bg-slate-900 hover:bg-amber-600 text-white rounded-2xl font-black uppercase tracking-[0.15em] text-[9px] shadow-lg shadow-slate-150 hover:shadow-amber-100 transition-all active:scale-95 flex items-center gap-2 cursor-pointer font-bold"
                    >
                      Update Work
                    </button>
                  </div>
            ...
            >
              <div className="flex justify-between items-center pb-5 border-b border-slate-100">
                <div className="flex items-center gap-3 text-left">
                  <div className="w-10 h-10 rounded-xl bg-amber-50 text-amber-655 border border-amber-100 flex items-center justify-center shrink-0 shadow-sm">
              ...
              <form onSubmit={handleUpdateTask} className="space-y-5 text-left">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-2 text-left">
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-200 text-slate-700 font-bold text-xs rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-amber-500/10 cursor-pointer transition-all"
                    >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-4">
                    <input
                      ...
                      className="w-full h-2 bg-slate-150 rounded-lg appearance-none cursor-pointer accent-amber-500"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 text-xs bg-slate-50/50 placeholder-slate-400 focus:outline-none focus:border-amber-500/25 focus:ring-2 focus:ring-amber-500/10 transition-all font-semibold text-slate-850 resize-none"
                  />
                </div>
                ...
                <div className="pt-4 flex justify-end gap-3.5 border-t border-slate-100">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-6 py-3 rounded-xl bg-amber-500 hover:bg-amber-600 disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed text-white text-[10px] font-black uppercase tracking-wider shadow-md hover:shadow-lg transition-all cursor-pointer active:scale-95 font-bold"
                  >
