  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setLoginMessage({
          type: "success",
          text: `Authenticated successfully as ${roleDisplay}! Redirecting to your operational workspace...`
        });

        // Redirect to the appropriate dashboard after a snappy, satisfying delay
        setTimeout(() => {
