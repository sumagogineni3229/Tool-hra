  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 py-2">
        {[
          { label: "Earned Leave", key: "earned", total: 12, colors: ["#10b981", "#059669"], dbType: "Earned" },
          { label: "Sick Leave", key: "sick", total: 4, colors: ["#ef4444", "#dc2626"], dbType: "Sick" },
          { label: "Emergency Leave", key: "emergency", total: 2, colors: ["#f59e0b", "#d97706"], dbType: "Emergency" },
